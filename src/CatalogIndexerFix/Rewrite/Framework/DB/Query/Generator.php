...
use Silarn\CatalogIndexerFix\Rewrite\Framework\DB\Query\BatchIteratorFactory;
use Silarn\CatalogIndexerFix\Rewrite\Framework\DB\Query\BatchRangeIteratorFactory;
...
class Generator
{
     ...
     * \Silarn\CatalogIndexerFix\Rewrite\Framework\DB\Query\BatchIteratorInterface::UNIQUE_FIELD_ITERATOR.
     * This parameter is determine, what instance of Iterator will be returned.
     *
     * Other params:
     ...
     *
     * @see \Silarn\CatalogIndexerFix\Rewrite\Framework\DB\Query\BatchIteratorInterface
    ...
    public function generate(
        ...
        $batchSize = 100,
        $batchStrategy = \Silarn\CatalogIndexerFix\Rewrite\Framework\DB\Query\BatchIteratorInterface::UNIQUE_FIELD_ITERATOR
    ) {
        if ($batchStrategy == \Silarn\CatalogIndexerFix\Rewrite\Framework\DB\Query\BatchIteratorInterface::NON_UNIQUE_FIELD_ITERATOR) {
